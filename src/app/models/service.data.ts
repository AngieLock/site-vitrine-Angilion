...
export const SERVICES: Service[] = [
    {
        ...
        list: ['Analyse approfondie de votre organisation',
            ...
            'Amélioration des échanges internes',],
...
<path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    ...
    },
    {
        ...
        list: ['Étude comparative et recommandations sur mesure',
            'Intégration complète à votre système existant',
            'Formation et support post-installation',
            'Mise à jour continue pour rester performant',],
        icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
